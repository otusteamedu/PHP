...
CREATE
INDEX attribute_type_id_idx ON public.attribute_type USING btree (id);
...
CREATE
INDEX movie_id_idx ON public.movie USING btree (id);
...
CREATE
INDEX attribute_id_idx ON public.attribute USING btree (id);
...
CREATE
INDEX movie_attribute_value_movie_id_idx ON public.movie_attribute_value USING btree (movie_id, attribute_id);
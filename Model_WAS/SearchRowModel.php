...
class SearchRowModel extends BaseModel
{
    /* Артикул  */
    public $article;
    /* Производитель */
    ...
    /**
     * Заполнить модель данными детали с полными данными
     * @param string $name - название детали в списке деталей файла json
     */
    public function setFullDetail($name)
    {
        $this->init($this->jsonData['full'][$name]);
    }

    /**
     * Заполнить модель данными детали с минимальными данными (артикул-бренд)
     * @param string $name - название детали в списке деталей файла json
     */
    public function setShortDetail($name = 'defaultValue')
    {
        $this->init($this->jsonData['short'][$name]);
    }

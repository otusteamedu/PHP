...
class ClientModel extends BaseModel
{
    ...
    public function setClientDisplayStateModel($jsonBlockName)
    {
        $this->init($this->jsonData['ClientDisplayStatesCest'][$jsonBlockName]);
    }

    public function setTestClient()
    {
        $this->init($this->jsonData['testClient']);
    }

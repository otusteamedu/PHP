...
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('hobbit1','the good one','2011-10-10','2011-10-11',true);
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('hobbit2','not the good one','2012-10-10','2012-10-11',false);
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('hobbit3','the bad one','2013-10-10','2013-10-11',false);
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('matrix1','the good one','2001-10-10','2011-10-11',true);
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('matrix2','not the good one','2002-10-10','2011-10-11',false);
insert into movie(title,description,world_premier,rf_premier,has_oscar) 
values ('matrix3','the bad one','2003-10-10','2011-10-11',false);

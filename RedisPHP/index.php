...
<body>
<form method="post" action="App/Actions/addEvent.php">
...
<form method="post" action="/App/Actions/deleteAll.php">
    <button type="submit" onclick="alert('Вы точно хотите удалить все события?')">Удалить все</button>
</form>

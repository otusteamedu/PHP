...
Заполнить таблицы, увеличив общее количество строк текстовых данных до 1000000.
Провести анализ производительности запросов к БД, сохранить планы выполнения.
...
- план на БД до 1000000 строк
- план на БД до 1000000 строк, что удалось улучшить

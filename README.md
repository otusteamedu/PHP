...
1. запустить скрипт `optimization.sql`, объяснения к методам оптимизации и результаты приведены в том же [документе](report.md), в разделе **Проведенные меры оптимизации** и **После оптимизации**.

...
CREATE INDEX seats_id_price_idx ON public.seats USING btree (id_price);
CREATE INDEX seats_id_seat_type_idx ON public.seats USING btree (id_seat_type);
...
CREATE INDEX tickets_id_seat_idx ON public.tickets USING btree (id_seat);

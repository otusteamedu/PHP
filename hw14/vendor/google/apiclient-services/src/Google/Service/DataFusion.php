 ...
 * @author Google, Inc.
 */
class Google_Service_DataFusion extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->projects_locations_instances = new Google_Service_DataFusion_Resource_ProjectsLocationsInstances(
        $this,
        $this->serviceName,
        'instances',
        array(
    ...
    $this->projects_locations_operations = new Google_Service_DataFusion_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
